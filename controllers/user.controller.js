...
//rendering user profile based on username available on dashboard
async function renderUserProfileByUsername(req, res) {
...
async function userProfile(req, res) {
  ...
  connection.query(profileQuery, [userID, userID], (error, results) => {
    if (error) {
...
async function fetchUsernameByPost(req, res) {
  const username = req.params.username;
